...
namespace ApiManagement.Models.SmartFactoryModel
{
    public class SmartTaskOrderScheduleHelper : DataHelper
    {
        private SmartTaskOrderScheduleHelper()
        {
            ...
            InsertSql =
                "INSERT INTO `t_task_order_schedule` (`CreateUserId`, `MarkedDateTime`, `Batch`, `ProcessTime`, `TaskOrderId`, `ProcessId`, `PId`, `ProductId`, `Target`, `Put`, `Rate`, `Stock`, `DoneTarget`, `Done`, `DoingCount`, `Doing`, `IssueCount`, `Issue`) " +
                "VALUES (@CreateUserId, @MarkedDateTime, @Batch, @ProcessTime, @TaskOrderId, @ProcessId, @PId, @ProductId, @Target, @Put, @Rate, @Stock, @DoneTarget, @Done, @DoingCount, @Doing, @IssueCount, @Issue);";
