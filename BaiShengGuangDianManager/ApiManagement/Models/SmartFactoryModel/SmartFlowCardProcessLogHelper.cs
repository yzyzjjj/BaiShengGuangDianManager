...
namespace ApiManagement.Models.SmartFactoryModel
{
    public class SmartFlowCardProcessLogHelper : DataHelper
    {
        private SmartFlowCardProcessLogHelper()
        {
            ...
            InsertSql =
                "INSERT INTO `t_flow_card_process_log` (`CreateUserId`, `MarkedDateTime`, `WorkshopId`, `ProcessId`, `ProcessorId`, `DeviceId`, `StartTime`, `EndTime`, `Count`, `Before`, `Doing`, `Qualified`, `Unqualified`) " +
                "VALUES (@CreateUserId, @MarkedDateTime, @WorkshopId, @ProcessId, @ProcessorId, @DeviceId, @StartTime, @EndTime, @Count, @Before, @Doing, @Qualified, @Unqualified);";
            UpdateSql =
